namespace Team9_AD.Entity
{
    ...
    public partial class Logic_University_Entity : DbContext
    {
        public Logic_University_Entity()
            : base("name=Logic_University_Entity")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Voucher_details>()
                .Property(e => e.Amount)
                .HasPrecision(18, 0);
