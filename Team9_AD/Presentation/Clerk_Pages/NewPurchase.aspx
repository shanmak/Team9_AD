<%@ Page Title="" Language="C#" MasterPageFile="~/Clerk_Master.Master" AutoEventWireup="true" CodeBehind="NewPurchase.aspx.cs" Inherits="Team9_AD.NewPurchase" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div>
             <center><b>New Purchase Item</b></center>
        <br />
        <br />
    ...
    <td><asp:DropDownList ID="ddl_Category" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Category_SelectedIndexChanged"/>
        ...
        <br />
        <center><asp:Button ID="Btn_purchase" runat="server" Font-Bold="true" Text="Add Purchase Item" OnClick="Btn_purchase_Click"/></center>
