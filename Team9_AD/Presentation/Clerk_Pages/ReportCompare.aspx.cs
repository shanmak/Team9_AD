...
namespace Team9_AD
{
    public partial class ReportCompare : System.Web.UI.Page
    {
        /*Code by Surendran*/
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sup1 = model.Goods_Received.Where(x => x.Supplier_ID == DeptOrSupp1.SelectedValue).Select(x => x.Supplier_ID).ToString();
                string sup2 = model.Goods_Received.Where(x => x.Supplier_ID == DeptOrSupp2.SelectedValue).Select(x => x.Supplier_ID).ToString();
                string sup3 = model.Goods_Received.Where(x => x.Supplier_ID == DeptOrSupp3.SelectedValue).Select(x => x.Supplier_ID).ToString();
                string itemname = descriptionDDL.SelectedValue.ToString();
