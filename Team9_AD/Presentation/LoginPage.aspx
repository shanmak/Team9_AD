...
<body>
    ...
    <form method="post" runat="server">
       ...
       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Password" ControlToValidate="password"></asp:RequiredFieldValidator>--%>
        <div class="form-group"><asp:Button class="btn btn-primary btn-block" type="submit" runat="server" Text="Log In" OnClick="Login_Click"></asp:Button></div>
        <asp:Label ID="Label1" runat="server" Text="Invalid Credentials" ForeColor="Red"></asp:Label>
    </form>
    </div>
