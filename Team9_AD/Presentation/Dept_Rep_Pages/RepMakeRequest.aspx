<%@ Page Title="" Language="C#" MasterPageFile="~/RepMasterPage.Master" AutoEventWireup="true" CodeBehind="RepMakeRequest.aspx.cs" Inherits="Team9_AD.RepMakeRequest" %>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
    ...
    <br />
        ...
        &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp
        <asp:Button ID="btn_Addrequest" runat="server" Text="Add New Request" CssClass="btn btn-warning" Font-Bold="true" OnClick="btn_Addrequest_Click" />
&nbsp;&nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp
        <asp:Button ID="btn_Submitrequest" runat="server" Text="Submit Request" CssClass="btn btn-success" Font-Bold="true" OnClick="btn_Submitrequest_Click"/>
