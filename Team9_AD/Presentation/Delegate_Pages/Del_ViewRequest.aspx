<%@ Page Title="" Language="C#" MasterPageFile="~/Delegate.Master" AutoEventWireup="true" CodeBehind="Del_ViewRequest.aspx.cs" Inherits="Team9_AD.Del_ViewRequest" %>
...
<ItemStyle HorizontalAlign="Center" ></ItemStyle>
                   ...
                   <ItemTemplate>                     
                    <asp:Button ID="Button1" runat="server" Text="Details"  OnClick="Details" />
                    </ItemTemplate>
<ItemStyle HorizontalAlign="Center" ></ItemStyle>
                    </asp:TemplateField>
                </Columns> 
