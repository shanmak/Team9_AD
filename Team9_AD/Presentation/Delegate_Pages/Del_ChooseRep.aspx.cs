...
namespace Team9_AD
{
    public partial class Del_ChooseRep : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                using (WebClient webclient = new WebClient())
                {
                    ...
                    string json = webclient.DownloadString("http://172.17.61.116/AD_Service/WCF/Service1.svc/departmentemployeelist/" + id);
