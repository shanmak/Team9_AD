...
namespace Team9_AD
{
    public partial class Del_View_Details : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                else
                {
                    count = count + 1;
                    GridViewRow r = (GridViewRow)chk.NamingContainer;
                    //  string itemID = GridView1.DataKeys[r.RowIndex].Values[0].ToString();
            ...
            Response.Write(@"<script language='javascript'>alert('Approved  successfully');window.location.href='Del_View_Page.aspx'</script>");
        ...
        {
            Response.Redirect("Del_View_Page.aspx");
        }
    }
}