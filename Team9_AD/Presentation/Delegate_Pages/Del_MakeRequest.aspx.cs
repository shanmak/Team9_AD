...
namespace Team9_AD
{
    public partial class Del_MakeRequest : System.Web.UI.Page
    {
        ...
        protected void btn_Submitrequest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //string v = sm.Employees.Where(x => x.Employee_ID == empid).FirstOrDefault<Employee>().Email;
                //mail.From = new MailAddress(v, name);
                ...
                Response.Write(@"<script language='javascript'>alert('Request Sent successfully');window.location.href='Del_Home_Page.aspx'</script>");
